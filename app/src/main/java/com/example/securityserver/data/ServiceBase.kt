...
object ServiceBase {
	...
	suspend fun getServers(): StoredDomains? = coroutineScope {
		async {
			println("here in getServers from DB")
			...
			return@async storedDomains
		}.await()
	}
//
//	suspend fun getServersAsync(): Deferred<StoredDomains?> = coroutineScope {
//		async {
//			println("here in getServersAsync")
//			getServers()
//		}
//	}
